...
#ifndef HWUART_LPC_V3_H_
#define HWUART_LPC_V3_H_

#define HWUART_PRE_ONLY
#include "hwuart.h"

class THwUart_lpc_v3 : public THwUart_pre
{
public:
...
#define HWUART_IMPL THwUart_lpc_v3

#endif // def HWUART_LPC_V3_H_
