...
#ifndef HWCLKCTRL_LPC_V3_H_
#define HWCLKCTRL_LPC_V3_H_

#define HWCLKCTRL_PRE_ONLY
#include "hwclkctrl.h"

class THwClkCtrl_lpc_v3 : public THwClkCtrl_pre
{
public:
	void StartExtOsc();
	bool ExtOscReady();
...
#define HWCLKCTRL_IMPL THwClkCtrl_lpc_v3
