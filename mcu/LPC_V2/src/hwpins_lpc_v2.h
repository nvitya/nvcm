...
#ifndef _HWPINS_LPC_V2_H
#define _HWPINS_LPC_V2_H

#define HWPINS_PRE_ONLY
#include "hwpins.h"

class THwPinCtrl_lpc_v2 : public THwPinCtrl_pre
{
public:
	// platform specific
...
class TGpioPin_lpc_v2 : public TGpioPin_common
{
public:
	HW_GPIO_REGS *   regs;
...
#define HWPINCTRL_IMPL   THwPinCtrl_lpc_v2
#define HWGPIOPORT_IMPL  TGpioPort_lpc_v2
#define HWGPIOPIN_IMPL   TGpioPin_lpc_v2

#endif /* HWPINS_LPC_V2_H_ */
