...
#ifndef HWUART_LPC_V2_H_
#define HWUART_LPC_V2_H_

#define HWUART_PRE_ONLY
#include "hwuart.h"

class THwUart_lpc_v2 : public THwUart_pre
{
public:
...
#define HWUART_IMPL THwUart_lpc_v2

#endif // def HWUART_LPC_V2_H_
