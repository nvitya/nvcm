...
#ifndef _HWPINS_KINETIS_H
#define _HWPINS_KINETIS_H

#define HWPINS_PRE_ONLY
#include "hwpins.h"

class THwPinCtrl_kinetis : public THwPinCtrl_pre
{
public:
	// platform specific
...
class TGpioPort_kinetis : public TGpioPort_pre
{
public:
...
class TGpioPin_kinetis : public TGpioPin_common
{
public:
...
#define HWPINCTRL_IMPL   THwPinCtrl_kinetis
#define HWGPIOPORT_IMPL  TGpioPort_kinetis
#define HWGPIOPIN_IMPL   TGpioPin_kinetis

#endif /* HWPINS_KINETIS_H_ */
