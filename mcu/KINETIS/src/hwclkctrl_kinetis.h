...
#ifndef HWCLKCTRL_KINETIS_H_
#define HWCLKCTRL_KINETIS_H_

#define HWCLKCTRL_PRE_ONLY
#include "hwclkctrl.h"

class THwClkCtrl_kinetis : public THwClkCtrl_pre
{
public:
	void StartExtOsc();
	bool ExtOscReady();
...
#define HWCLKCTRL_IMPL THwClkCtrl_kinetis

#endif // def HWCLKCTRL_KINETIS_H_
